...
-- 正在导出表  zhengzihui_test_second.django_migrations 的数据：~16 rows (大约)
/*!40000 ALTER TABLE `django_migrations` DISABLE KEYS */;
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	(1, 'contenttypes', '0001_initial', '2016-07-19 03:19:01'),
	(2, 'auth', '0001_initial', '2016-07-19 03:19:01'),
	(3, 'admin', '0001_initial', '2016-07-19 03:19:02'),
	(4, 'admin', '0002_logentry_remove_auto_add', '2016-07-19 03:19:02'),
	(5, 'contenttypes', '0002_remove_content_type_name', '2016-07-19 03:19:02'),
	(6, 'auth', '0002_alter_permission_name_max_length', '2016-07-19 03:19:02'),
	(7, 'auth', '0003_alter_user_email_max_length', '2016-07-19 03:19:02'),
	(8, 'auth', '0004_alter_user_username_opts', '2016-07-19 03:19:02'),
	(9, 'auth', '0005_alter_user_last_login_null', '2016-07-19 03:19:02'),
	(10, 'auth', '0006_require_contenttypes_0002', '2016-07-19 03:19:02'),
	(11, 'auth', '0007_alter_validators_add_error_messages', '2016-07-19 03:19:02'),
	(12, 'easy_thumbnails', '0001_initial', '2016-07-19 03:19:02'),
	(13, 'easy_thumbnails', '0002_thumbnaildimensions', '2016-07-19 03:19:02'),
	(14, 'sessions', '0001_initial', '2016-07-19 03:19:02'),
	(15, 'zhengzihui_app', '0001_initial', '2016-07-19 03:19:03'),
	(16, 'zhengzihui_app', '0002_auto_20160719_1632', '2016-07-19 08:32:33');
...
-- 正在导出表  zhengzihui_test_second.django_session 的数据：~1 rows (大约)
...
CREATE TABLE IF NOT EXISTS `zhengzihui_app_tb_companyuser` (
  ...
  `companyUserPassword` varchar(100) NOT NULL,
  `companyUserCompanyName` varchar(100) NOT NULL,
  `companyUserCompanyLocation` varchar(100) NOT NULL,
  `companyUserCompanyAddress` varchar(100) NOT NULL,
  `companyUserCompanyCapital` varchar(100) NOT NULL,
  `companyUserCompanyPeople` varchar(100) NOT NULL,
  `companyUserCompanyIndustry` varchar(100) NOT NULL,
  `companyUserCompanyNature` varchar(100) NOT NULL,
  `companyUserContactName` varchar(40) NOT NULL,
  `companyUserPhone` varchar(40) NOT NULL,
  `companyUserTelephone` varchar(40) NOT NULL,
  `companyUserEmail` varchar(254) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zhengzihui_app_tb_goods` (
  ...
  `goods_accept_endtime` datetime,
  `goods_accept_starttime` datetime,
...
INSERT INTO `zhengzihui_app_tb_goods` (`goods_id`, `item_id`, `sp_id`, `goods_name`, `goods_market_price`, `goods_price`, `goods_price_discouint`, `goods_pay`, `goods_guarantee`, `goods_sort`, `goods_commend`, `goods_evaluation_good_star`, `goods_evaluation_count`, `goods_show`, `goods_status`, `goods_accept_endtime`, `goods_accept_starttime`, `goods_awardafter`, `goods_code`, `goods_payahead`) VALUES
	(1, 1, 1, ' 2016科技厅关于科技计划项目的申报通知', 100000, 300, 1, 1, '1', 1, 0, 1, 1, 1, 0, '2016-09-19 17:20:14', '2016-07-19 17:20:16', 10000, 3, 10000),
	(2, 1, 1, ' 2016科技厅关于科技计划项目的申报通知', 18888, 900, 1, 1, '1', 2, 0, 4, 1, 1, 0, '2016-09-19 17:20:09', '2016-07-19 17:20:10', 1000, 2, 1000),
	(3, 1, 1, ' 2016科技厅关于科技计划项目的申报通知', 56781, 1000, 3, 1, '1', 3, 0, 5, 1, 1, 0, '2016-09-19 17:19:55', '2016-06-19 17:19:57', 100, 1, 100);
...
CREATE TABLE IF NOT EXISTS `zhengzihui_app_tb_item_pa` (
  ...
  `area_id` int(11) NOT NULL,
  `ipa_address` varchar(1000) NOT NULL,
  PRIMARY KEY (`ipa_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `zhengzihui_app_tb_order` (`order_id`, `order_no`, `goods_id`, `pay_no`, `item_id`, `item_name`, `sp_id`, `sp_name`, `buyer_id`, `buyer_name`, `buyer_email`, `add_time`, `payment_code`, `payment_time`, `final_time`, `good_amount`, `order_amount`, `refund_amount`, `delay_time`, `order_from`, `express_id`, `express_no`, `eval_state`, `order_state`, `refund_state`, `lock_state`, `express_state`) VALUES
	...
	(2, 2, 0, 2, 2, '2016科技厅关于科技计划项目的申报通知', 1, '1', 3, '1', '1@qq.com', '2016-05-03 03:41:10', '1', '2016-05-03 03:41:11', '2016-05-03 03:41:14', 1, 8888, 1, '2016-05-03 03:41:23', 1, 1, '1', 0, 1, 0, 0, 1),
...
-- 正在导出表  zhengzihui_test_second.zhengzihui_app_tb_user 的数据：~8 rows (大约)
...
INSERT INTO `zhengzihui_app_tb_user` (`user_id`, `user_name`, `user_password`, `user_telephone`, `user_email`, `user_auth`, `user_type`) VALUES
	...
	(8, 'yz', '123456', '214124', '324234@qq.com', 1, 0);
