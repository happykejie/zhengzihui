...
-- 正在导出表  zhengzihui_test_second.auth_permission 的数据：~171 rows (大约)
...
-- 正在导出表  zhengzihui_test_second.django_content_type 的数据：~57 rows (大约)
...
-- 正在导出表  zhengzihui_test_second.django_migrations 的数据：~44 rows (大约)
...
-- 正在导出表  zhengzihui_test_second.django_session 的数据：~29 rows (大约)
...
INSERT INTO `zhengzihui_app_tb_back_user` (`user_id`, `user_name`, `user_password`, `user_telephone`, `user_email`, `user_auth`, `user_type`, `last_login`) VALUES
	(1, 'yz', '123', '5654645', 'skjkd@', 1, 2, '2016-10-09 02:19:25'),
...
INSERT INTO `zhengzihui_app_tb_goods` (`goods_id`, `item_id`, `sp_id`, `goods_name`, `goods_market_price`, `goods_code`, `goods_payahead`, `goods_awardafter`, `goods_accept_starttime`, `goods_accept_endtime`, `goods_price`, `goods_price_discouint`, `goods_pay`, `goods_guarantee`, `goods_sort`, `goods_commend`, `goods_evaluation_good_star`, `goods_evaluation_count`, `goods_show`, `goods_status`, `cont`, `exa`, `steps`, `fea`, `smod`, `goods_fanli`, `goods_awardmid`, `goods_area`) VALUES
	(1, 1, 1, 'service_ 2016科技厅关于科技计划项目的申报通知', 100000, 3, 10000, 10000, '2016-07-19 17:20:16', '2016-09-19 17:20:14', 300, 1, 1, '1', 1, 0, 1, 1, 0, 0, 'a', 'a', 'a', '', '', '100', 0, '北京'),
	(2, 3, 1, 'service_ 2016科技厅关于科技计划项目的申报通知', 18888, 2, 1000, 1000, '2016-07-19 17:20:10', '2016-09-19 17:20:09', 900, 1, 1, '1', 2, 0, 4, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, '100', 0, '北京'),
	(3, 1, 1, 'service_ 2016科技厅关于科技计划项目的申报通知', 56781, 1, 100, 100, '2016-06-19 17:19:57', '2016-09-19 17:19:55', 1000, 3, 1, '1', 3, 0, 5, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, '100', 0, '北京');
...
-- 正在导出表  zhengzihui_test_second.zhengzihui_app_tb_order 的数据：~4 rows (大约)
...
-- 正在导出表  zhengzihui_test_second.zhengzihui_app_tb_rongzi_item 的数据：~0 rows (大约)
