...
INSERT INTO `zhengzihui_app_tb_goods_click` VALUES (1,1,' 2016科技厅关于科技计划项目的申报通知',0,3);
...
CREATE TABLE IF NOT EXISTS `zhengzihui_app_tb_service_provider` (
  ...
  `sp_id` int(11) NOT NULL,
  `sp_name` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  `psw` varchar(40) COLLATE utf8_unicode_ci  NULL,
  `tel` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(254) COLLATE utf8_unicode_ci  NOT NULL,
  `master` varchar(50) COLLATE utf8_unicode_ci  NULL,
  `sp_image1` varchar(100) COLLATE utf8_unicode_ci  NULL,
  `sp_image2` varchar(100) COLLATE utf8_unicode_ci  NULL,
  `sp_grade` int(11)  NULL,
  `sp_sort` int(11)  NULL,
  `area_id` varchar(10) COLLATE utf8_unicode_ci  NULL,
  `Register_cap` int(11)  NULL,
  `staff_number` int(11)  NULL,
  `Annual_totals` int(11)  NULL,
  `organization_name` varchar(40) COLLATE utf8_unicode_ci  NULL,
  `organization_id` int(11)  NULL,
  `organization_assets` int(11)  NULL,
  `organization_profile` varchar(100) COLLATE utf8_unicode_ci  NULL,
  `sp_auth` int(11)  NULL,
  `is_recommend` int(11)  NULL,
  `sp_type` varchar(60) NOT NULL,
  `con_name` int(30) NOT NULL,  
  PRIMARY KEY (`sp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
