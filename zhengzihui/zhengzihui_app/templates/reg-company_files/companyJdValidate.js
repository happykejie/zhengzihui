    ...
    $('#protocol').click(function () {
        jQuery.jdThickBox({
            ...
            source: "<div class=\" regist-2013\">" +
                ...
                "<p>"+
                "本协议是用户（以下简称“您”）与京东网站（网址：包括但不限于www.jd.com等，简称“本站”）所有者及其关联公司（以下简称为“京东”）之间就京东网站服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击\"同意并继续\"按钮后，即视为您接受并同意遵守本协议的约定。</p>"+
                "<h5> 第1条 本站服务条款的确认和接纳</h5>"+

                "<p>"+
                "<strong>1.1</strong>本站的各项电子服务的所有权和运作权归京东所有。您同意所有注册协议条款并完成注册程序，才能成为本站的正式用户。您确认：本协议条款是处理双方权利义务的依据，始终有效，法律另有强制性规定或双方另有特别约定的，依其规定或约定。"+
                "</p>"+

                "<p>"+
                "<strong>1.2</strong>您点击同意本协议的，即视为您确认自己具有享受本站服务、下单购物等相应的权利能力和行为能力，能够独立承担法律责任。</p>"+

                "<p>"+
                "<strong>1.3</strong>您确认，如果您在18周岁以下，您只能在父母或其他监护人的监护参与下才能使用本站。</p>"+
               
                "1.4<strong><em>京东保留在中华人民共和国大陆地区施行之法律允许的范围内独自决定拒绝服务、关闭用户账户、清除或编辑内容或取消订单的权利。</em></strong>"+
                
                "<p>"+
                "<strong>1.5</strong>您使用本站提供的服务时，应同时接受适用于本站特定服务、活动等的准则、条款和协议（以下统称为“其他条款”）；如果以下使用条件与“其他条款”有不一致之处，则以“其他条款”为准。</p>"+
                
                "<p>"+
                "<strong>1.6</strong>为表述便利，商品和服务简称为“商品”或“货物”。</p>"+
                "<h5> 第2条 本站服务</h5>"+

                "<p>"+
                "<strong>2.1</strong>京东通过互联网依法为您提供互联网信息等服务，您在完全同意本协议及本站相关规定的情况下，方有权使用本站的相关服务。</p>"+

                "<p>"+
                "<strong>2.2</strong>您必须自行准备如下设备和承担如下开支：（1）上网设备，包括并不限于电脑或者其他上网终端、调制解调器及其他必备的上网装置；（2）上网开支，包括并不限于网络接入费、上网设备租用费、手机流量费等。"+
                "</p>"+
                "<p>"+
                "<strong>2.2.1</strong>上网设备，包括并不限于电脑或者其他上网终端、调制解调器及其他必备的上网装置；"+
                "</p>"+
                "<p>"+
                "<strong>2.2.2</strong>上网开支，包括并不限于网络接入费、上网设备租用费、手机流量费等。"+
                "</p>"+
                "<h5> 第3条 用户信息收集及保护</h5>"+

                "<p>"+
                "<strong>3.1</strong>您应自行诚信向本站提供注册资料，您保证提供的注册资料真实、准确、完整、合法有效，您的注册资料如有变动的，应及时更新其注册资料。如果您提供的注册资料不合法、不真实、不准确、不详尽的，您需承担因此引起的相应责任及后果，并且京东保留单方终止您使用京东各项服务的权利。"+
                "</p>"+

                "<p>"+
                "<strong>3.2</strong>您在本站进行注册、浏览、下单购物、评价、参加活动等行为时，涉及您真实姓名/名称、通信地址、联系电话、电子邮箱、订单详情、评价或反馈、投诉内容、cookies等信息的，本站有权从完成交易、提供配送、售后及客户服务、开展活动、完成良好的客户体验等多种角度予以收集，并将对其中涉及个人隐私信息予以严格保密，除非得到您的授权、为履行强行性法律义务（如国家安全机关指令）或法律另有规定、本注册协议或其他条款另有约定外，本站不会向外界披露您的隐私信息。"+
                "</p>"+

                "<p>"+
                "<strong>3.3</strong>您注册成功后，将产生用户名和密码等账户信息，您可以根据本站规定更改您的密码。您应谨慎合理的保存、使用您的账户信息。您若发现任何非法使用您的账户或其他存在安全漏洞的情况的，请立即通知本站并向公安机关报案。"+
                "</p>"+

                "<p>"+
                "<strong>3.4</strong><strong>您同意，京东拥有通过邮件、短信、电话、网站通知或声明等形式，向在本站注册、购物的用户、收货人发送订单信息、促销活动、售后服务、客户服务等告知信息的权利。如您不希望接收上述信息，可退订。</strong></p>"+

                "<p>"+
                "<strong>3.5</strong><strong>您同意：您选择向本站的商品销售商或服务提供商（以下统称为“销售商”，含京东及第三方卖家）提交订单购买商品或服务的，视为您向销售商披露个人相关信息，接受销售商向您提供商品销售、配送、售后服务、客户服务、处理信用卡付款、数据分析、市场营销帮助或其他必要事宜；如前述全部或部分事宜之一涉及由销售商外的第三方履行的，销售商有权将您的信息以必要方式向第三方披露，第三方有权以履行上述事宜为目的联系您。</strong></p>"+

                "<p>"+
                "<strong>3.6</strong><strong>您不得将在本站注册获得的账号、密码等账户信息提供给他人使用，否则您应承担由此产生的全部责任，并与实际使用人承担连带责任。</strong>"+
                "</p>"+
                "<p>"+
                "<strong>3.7</strong><strong>您同意，京东有权使用您的注册信息、用户名、密码等信息，登陆进入您的注册账户，进行证据保全，包括但不限于公证、见证、协助司法机关进行调查取证等。</strong>"+
                "</p>"+
                "<h5> 第4条 用户依法言行义务</h5>"+
                ...
                "<p>"+
                "<strong>4.1</strong>不得传输或发表：煽动抗拒、破坏宪法和法律、行政法规实施的言论，煽动颠覆国家政权，推翻社会主义制度的言论，煽动分裂国家、破坏国家统一的言论，煽动民族仇恨、民族歧视、破坏民族团结的言论；"+
                "</p>"+
                "<p>"+
                "<strong>4.2</strong>从中国大陆向境外传输资料信息时必须符合中国有关法律法规；"+
                "<p>"+
                "<strong>4.3</strong>不得利用本站从事洗钱、窃取商业秘密、窃取个人信息等违法犯罪活动；"+
                "</p>"+
                "<p>"+
                "<strong>4.4</strong>不得干扰本站的正常运转，不得侵入本站及国家计算机信息系统；"+
                "</p>"+
                "<p>"+
                "<strong>4.5</strong>不得传输或发表任何违法犯罪的、骚扰性的、中伤他人的、辱骂性的、恐吓性的、伤害性的、庸俗的，淫秽的、不文明的等信息资料；"+
                "</p>"+
                "<p>"+
                "<strong>4.6</strong>不得传输或发表损害国家社会公共利益和涉及国家安全的信息资料或言论；"+
                "</p>"+
                "<p>"+
                "<strong>4.7</strong>不得教唆他人从事本条所禁止的行为；"+
                "</p>"+
                "<p>"+
                "<strong>4.8</strong>除本注册协议、其他条款或另有其他约定外，您不得利用在本站注册的账户进行经营活动、牟利行为及其他未经本站许可的行为，包括但不限于以下行为："+
                "</p>"+
                "<p>"+
                "<strong>4.8.1</strong>您账户内的任何京东优惠信息（包括但不限于京券、东券、京豆及其他形式优惠或折扣等）由京东享有解释权和修改权，您仅享有在京东购物时的使用权，严禁转卖京东账户、京券、东券、京豆或其他类型的优惠券、京东卡、或利用京东账户进行其他经营性行为等；"+
                "<p>"+
                "<strong>4.8.2</strong>恶意利用技术手段或其他方式，为获取优惠、折扣或其他利益而注册账户、下单等行为，影响其他用户正常消费行为或相关合法权益、影响京东正常销售秩序的行为；"+
                "</p>"+
                "<p>"+
                "<strong>4.8.3</strong>发布广告、垃圾邮件；"+
                "</p>"+
                "<p>"+
                "<strong>4.8.4</strong>以再销售或商业使用为目的对本站商品或服务进行购买的（与京东另有合同约定的除外）；"+
                "</p>"+
                "<p>"+
                "<strong>4.8.5</strong>商品或服务的供应商、代理商对其所供商品进行回购的行为；"+
                "</p>"+
                "<p>"+
                "<strong>4.8.6</strong>任何对商品目录、说明、价格、数量、其他用户信息或其他内容的下载、转载、收集、衍生利用、复制、出售、转售或其他形式的使用，无论是否通过Robots、Spiders、自动仪器或手工操作；"+
                "</p>"+
                "<p>"+
                "<strong>4.8.7</strong>本站相关规则、政策、或网页活动规则中限制、禁止的行为；"+
                "</p>"+
                "<p>"+
                "<strong>4.8.8</strong>其他影响京东对用户账户正常管理秩序的行为。"+
                "</p>"+
                "<p>"+
                "<strong>4.9</strong>您不得利用任何非法手段获取其他用户个人信息，不得将其他用户信息用于任何营利或非营利目的，不得泄露其他用户或权利人的个人隐私，否则京东有权采取本协议规定的合理措施制止您的上述行为，情节严重的，将提交公安机关进行刑事立案。"+
                "</p>"+
                "<p>"+
                "<strong>4.10</strong>您不得发布任何侵犯他人著作权、商标权等知识产权或其他合法权利的内容；如果有其他用户或权利人发现您发布的信息涉嫌知识产权、或其他合法权益争议的，这些用户或权利人有权要求京东删除您发布的信息，或者采取其他必要措施予以制止，京东将会依法采取这些措施。"+
                "</p>"+
                "<p>"+
                "<strong>4.11</strong>您应不时关注并遵守本站不时公布或修改的各类规则规定。本站保有删除站内各类不符合法律政策或不真实的信息内容而无须通知您的权利。"+
                "</p>"+
                "<p>"+
                "<strong>4.12</strong>若您未遵守以上规定的，本站有权做出独立判断并采取暂停或关闭您的账号、冻结账号内余额及京东卡金额、关闭相应交易订单、停止发货等措施。您须对自己在网上的言论和行为承担法律责任。"+
                "</p>"+
                ...
                "<p> <strong>5.1</strong>本站售后服务政策为本协议的组成部分，京东有权以声明、通知或其他形式变更售后服务政策。</p>"+
                "<h5> 第6条 订单</h5>"+

                "<p>"+
                "<strong>6.1</strong>在您下订单时，请您仔细确认所购商品的名称、价格、数量、型号、规格、尺寸、联系地址、电话、收货人等信息。<span>收货人与您本人不一致的，收货人的行为和意思表示视为您的行为和意思表示，您应对收货人的行为及意思表示的法律后果承担连带责任。</span>"+
                "</p>"+

                "<strong>6.2</strong>除法律另有强制性规定外，双方约定如下：<strong><em>本站上销售方展示的商品和价格等信息仅仅是交易信息的发布，您下单时须填写您希望购买的商品数量、价款及支付方式、收货人、联系方式、收货地址等内容；系统生成的订单信息是计算机信息系统根据您填写的内容自动生成的数据，仅是您向销售方发出的交易诉求；销售方收到您的订单信息后，只有在销售方将您在订单中订购的商品从仓库实际直接向您发出时（ 以商品出库为标志），方视为您与销售方之间就实际直接向您发出的商品建立了交易关系；如果您在一份订单里订购了多种商品并且销售方只给您发出了部分商品时，您与销售方之间仅就实际直接向您发出的商品建立了交易关系；只有在销售方实际直接向您发出了订单中订购的其他商品时，您和销售方之间就订单中该其他已实际直接向您发出的商品才成立交易关系。您可以随时登录您在本站注册的账户，查询您的订单状态。</em></strong>"+
          
                "<p>"+
                "<strong>6.3</strong><strong>尽管销售商做出最大的努力，但商品目录里的一小部分商品可能会有定价错误。如果发现错误定价，将采取下列之一措施，且不视为违约行为：</strong>"+
                "</p>"+
                "<p>"+
                "<strong>6.3.1</strong><strong>如果某一商品的正确定价低于销售商的错误定价，销售商将按照较低的定价向您销售交付该商品。</strong>"+
                "</p>"+
                "<p>"+
                "<strong>6.3.2</strong><strong>如果某一商品的正确定价高于销售商的错误定价，销售商会通知您，并根据实际情况决定是否取消订单、停止发货、为已付款用户办理退款等。</strong>"+
                "</p>"+
                "<p>"+
                "<strong>6.4</strong><strong>由于市场变化及各种以合理商业努力难以控制的因素的影响，本站无法保证您提交的订单信息中希望购买的商品都会有货；如您下单所购买的商品，发生缺货，您有权取消订单，销售商亦有权取消订单，并为已付款的用户办理退款。</strong>"+
                "</p>"+

                "<h5> 第7条 配送</h5>"+

                "<p>"+
                "<strong>7.1</strong>销售商将会把商品（货物）送到您所指定的收货地址，所有在本站上列出的送货时间为参考时间，参考时间的计算是根据库存状况、正常的处理过程和送货时间、送货地点等相关信息估计得出的。"+
                "</p>"+

                "<p>"+
                "<strong>7.2</strong>因如下情况造成订单延迟或无法配送、交货等，销售商不承担延迟配送、交货的责任：</p>"+

                "<p>"+
                "<strong>（1）</strong>您提供的信息错误、地址不详细等原因导致的；"+
                "</p>"+
                ...
                "<p>"+
                "<strong>（4）</strong>未能在本站所示的送货参考时间内送货的；</p>"+
                "<p>"+
                "<strong>（5）</strong>因节假日、大型促销活动、店庆、预购或抢购人数众多等原因导致的；</p>"+
                "<p>"+
                "<strong>（6）</strong>不可抗力因素导致的，例如：自然灾害、交通戒严、突发战争等。</p>"+
                "<h5> 第8条 所有权及知识产权条款</h5>"+

                "<p>"+
                "<strong>8.1</strong><strong>您一旦接受本协议，即表明您主动将其在任何时间段在本站发表的任何形式的信息内容（包括但不限于客户评价、客户咨询、各类话题文章等信息内容）的财产性权利等任何可转让的权利，如著作权财产权（包括并不限于：复制权、发行权、出租权、展览权、表演权、放映权、广播权、信息网络传播权、摄制权、改编权、翻译权、汇编权以及应当由著作权人享有的其他可转让权利），全部独家且不可撤销地转让给京东所有，您同意京东有权就任何主体侵权而单独提起诉讼。</strong>"+
                "</p>"+

                "<p>"+
                "<strong>8.2</strong><strong>本协议已经构成《中华人民共和国著作权法》第二十五条（条文序号依照2011年版著作权法确定）及相关法律规定的著作财产权等权利转让书面协议，其效力及于您在京东网站上发布的任何受著作权法保护的作品内容，无论该等内容形成于本协议订立前还是本协议订立后。</strong>"+
                "</p>"+

                "<p>"+
                "<strong>8.3</strong><strong>您同意并已充分了解本协议的条款，承诺不将已发表于本站的信息，以任何形式发布或授权其他主体以任何方式使用（包括但不限于在各类网站、媒体上使用）。</strong>"+
                "</p>"+

                "<p>"+
                "<strong>8.4</strong><strong>京东有权不时地对本协议及本站的内容进行修改，并在本站张贴，无须另行通知您。在法律允许的最大限度范围内，京东对本协议及本站内容拥有解释权。</strong>"+
                "</p>"+
                ...
                "<p>"+
                "<strong>8.6</strong>本站所刊登的资料信息（包括但不限于文字、图表、商标、logo、标识、按钮图标、图像、声音文件片段、数字下载、数据编辑和软件等），均是京东或其内容提供者的财产，受中国和国际相关版权法规、公约等的保护，未经京东书面许可，任何第三方无权将上述资料信息复制、出版、发行、公开展示、编码、翻译、传输或散布至任何其他计算机、服务器、网站或其他媒介。本站上所有内容的汇编是京东的排他财产，受中国和国际版权法的保护。本站上所有软件都是京东或其关联公司或其软件供应商的财产，受中国和国际版权法的保护。您不得鼓励、协助或授权任何其他人复制、修改、反向工程、反向编译或反汇编、拆解或者试图篡改全部或部分软件，或利用软件创设衍生产品。"+
                "</p>"+

                "<h5> 第9条 责任限制及不承诺担保</h5>"+

                "<p>"+
                "<strong>9.1</strong>除非另有明确的书面说明,本站及其所包含的或以其他方式通过本站提供给您的全部信息、内容、材料、产品（包括软件）和服务，均是在“按现状”和“按现有”的基础上提供的。"+
                "</p>"+

                "<p><strong>9.2</strong>除非另有明确的书面说明,京东不对本站的运营及其包含在本站上的信息、内容、材料、产品（包括软件）或服务作任何形式的、明示或默示的声明或担保（根据中华人民共和国法律另有规定的以外）。"+
                "</p>"+

                "<p><strong>9.3</strong>京东不担保本站所包含的或以其他方式通过本站提供给您的全部信息、内容、材料、产品（包括软件）和服务、其服务器或从本站发出的电子信件、信息没有病毒或其他有害成分。"+
                "</p>"+

                "<p><strong>9.4</strong>如因不可抗力或其他本站无法控制的原因使本站销售系统崩溃或无法正常使用导致网上交易无法完成或丢失有关的信息、记录等，京东会合理地尽力协助处理善后事宜。"+
                "</p>"+

                "<p><strong>9.5</strong>您应对账户信息及密码承担保密责任，因您未能尽到信息安全和保密责任而致使您的账户发生任何问题的，您应承担全部责任。同时，因网络环境存在众多不可预知因素，因您自身终端网络原因（包括但不限于断网、黑客攻击、病毒等）造成您的京东账户或个人信息等被第三方窃取的，京东不承担赔偿责任。"+
                "</p>"+

                "<p><strong>9.6</strong>您了解并同意，京东有权应国家有关机关的要求，向其提供您在京东的用户信息和交易记录等必要信息。如您涉嫌侵犯他人合法权益，则京东有权在初步判断涉嫌侵权行为可能存在的情况下，向权利人提供您必要的个人信息。"+
                "</p>"+


                "<h5> 第10条 协议更新及用户关注义务</h5>"+
                "根据国家法律法规变化及网站运营需要，京东有权对本协议条款不时地进行修改，修改后的协议一旦被张贴在本站上即生效，并代替原来的协议。您可随时登陆查阅最新协议；<strong><em>您有义务不时关注并阅读最新版的协议、其他条款及网站公告。如您不同意更新后的协议，可以且应立即停止接受京东网站依据本协议提供的服务；如您继续使用本站提供的服务的，即视为同意更新后的协议。京东建议您在使用本站之前阅读本协议及本站的公告。</em></strong>"+
                ...
                "<p>"+
                "<strong>12.2</strong>京东尊重您的合法权利，本协议及本站上发布的各类规则、声明、售后服务政策等其他内容，均是为了更好的、更加便利的为您提供服务。本站欢迎您和社会各界提出意见和建议，京东将虚心接受并适时修改本协议及本站上的各类规则。"+
                "</p>"+

                "<p>"+
                "<strong>12.3</strong><span>本协议内容中以黑体、加粗、下划线、斜体等方式显著标识的条款，请您着重阅读。</span></p>"+
...
function validateRegName() {
    ...
    if (validateRules.isNull(loginName) || loginName == '') {
        ...
        $("#regName_error").html("请输入用户名").show().attr({ "class": "error" });
        return false;
    }
    return true;
}
...
function countDown2() {
    ...
    $("#bdyMobileButton").html(delayTime2 + '秒后重新获取');
    if (delayTime2 == 1) {
        delayTime2 = 120;
...
//    $("#bmobileCode_error").removeClass().addClass("focus").html("请输入短信验证码");
...
function bsendMobileCode() {
    ...
    if (validateRules.isNull(mobile)) {
        $("#mobile_error").removeClass().addClass("error").html("请输入手机号");
        $("#mobile_error").show();
        return;
    }
    if (!validateRules.isMobile(mobile)) {
        $("#mobile_error").removeClass().addClass("error").html("手机号码格式有误，请输入正确的手机号");
        $("#mobile_error").show();
        return;
    }
        ...
        success: function(result) {
            if (result) {
                ...
                if (obj.rs == 1 || obj.remain) {
                    ...
                    $("#bdyMobileButton").html("120秒后重新获取");
                    if (obj.remain) {
                        $("#bmobileCodeSucMessage").empty().html(obj.remain);
                    } else {
                            $("#bmobileCode_error").removeClass().empty().html("验证码已发送，请查收短信。");
                            $("#bmobileCode_error").show();
                    }
                ...
                if (obj.rs == -1) {
                	bmobileCodeError("网络繁忙，请稍后重新获取验证码");
                }
                if (obj.info) {
    ...
    jQuery.ajax({
        ...
        success: function(result) {
            if (result) {
                ...
                if (obj.success == 1) {
                    $("#mobile_error").hide();
                    $("#mobile_error").removeClass().addClass("error").html("该手机号已经被占用,请更换手机号码");
                    $("#mobile_error").show();
...
function mobileVal(){
    ...
    if(null!=salePhone&&""!=salePhone){
        if (!validateRules.isMobile(salePhone)||salePhone.length<7||salePhone.length>11){
            ...
            $("#companysite_error").removeClass().addClass("error").html("手机号码格式有误，请输入正确的手机号");
