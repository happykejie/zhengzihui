...
#首次只返回10条数据
    ...
    allthebumen = ['发展改革','经济和信息化','财政','国资','农业','林业','畜牧','渔业','粮食','中医药','烟草','商务','税务','工商','投资促进','海关','国土资源','住房城乡建设','交通运输','水利','能源','环境保护','民政','人力资源社会保障','扶贫','民族','人民银行','银监','证监','保监','质监','药监','安监','统计','组织部','宣传部','统战部','政策研究室','政法委','编办','直属机关工委','民革','民盟','民建','民促','农工党','致公党','九三学社','总工会','共青团','科协','妇联','工商联','青联','残联','供销社','贸易促进会','红十字会','壹基金公益基金会','阿里巴巴公益基金会','中国科学院','中国工程院','中国农业科学院','中国工程物理研究院','重庆农科院','北京大学','清华大学','复旦大学','浙江大学','南开大学','中国科技大学','中山大学','四川大学','中国航天科技集团','海尔集团','长虹集团','东方电力集团','中国农村科技卡开发中心','中国国际交流中心','四川省高高新技术产业金融服务中心']
