...
$(document).ready(function(){
    ...
    $(".f-labels").each(function(){
       if($(this).children("li").length <= 5){
           ...
           $(this).children("li:gt(4)").hide();//表示大于第2个的，开始索引从0开始//YZ 因为文字太长所以从第三个便开始隐藏
       }
    });
    ...
    $(".more").each(function(){
        $(this).click(function(){
            ...
            var $hidden_li = $(this).parent().children(".f-select").children("ul").children("li:gt(4)");//表示大于第2个的，开始索引从0开始 //YZ因为字太多会撑开div
    ...
    $(".multiple-delete").each(function() {
        $(this).click(function () {
            ...
            var $hidden_li = $(this).parent().parent().children("ul").children("li:gt(4)");//表示大于第2个的，开始索引从0开始 //YZ因为。。。。。
            ...
            $all_li.each(function () {
                ...
                $(this).bind("click.simple",function(){
                    ...
                    window.location.href = "/rongzi_filter_labels/?key_name="+key_name+"&filterkeys="+value;     //后期需要修改的部分！！！YZ
                });
	...
	$("#filter .multiple-enter > a").click(function(){
        if($(this).hasClass("active")){
			...
			window.location.href = "/rongzi_filter_labels/?key_name="+key_name+"&filterkeys="+String(multiple);//多远后期需要修改的部分YZ
    ...
    $("#filter .f-labels  li").bind("click.simple",function(){
            var key_name = $(this).parent().parent().prev(".f-head").children("span").attr("id");
            var value = $(this).children("a").text();
            window.location.href = "/rongzi_filter_labels/?key_name="+key_name+"&filterkeys="+value;       //单选，后期需要修改的部分YZ
    });
