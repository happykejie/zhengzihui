...
INSERT INTO `zhengzihui_app_tb_back_user` VALUES (1,'xucz','123456','111','1111',1,2);
...
CREATE TABLE `zhengzihui_app_tb_service_provider` (
  ...
  `sp_address` varchar(40) COLLATE utf8_unicode_ci,
  PRIMARY KEY (`sp_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-09-20 14:15:33
